# GEMINI.md - Gemini Drone Commander (X69) Development Guide
...
### 1. External Code Review (PRs without "Gemini" in title)
...
### 2. Follow-up & Remediation (PRs with "Gemini" in title)
- **Identify:** Monitor PRs created by "Gemini" for unresolved sub-issues.
...
- **Submission:** All work must be submitted via a PR with **"Gemini"** in the title.
